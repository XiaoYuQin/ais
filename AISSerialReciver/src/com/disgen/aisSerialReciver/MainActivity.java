...
//	TcpClient tcpClient; 
	...
	UartReciveThread uartReciveThread;
...
//		else if(machineStatus == 2)
    	...
    	XXX = (TextView)findViewById(R.id.TextView24);
...
//		});
		button01.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				//这里的按键按下，设置了文本框的输入为AES的密码
				uartReciveThread.init(aes);
...
//					tcpServer.setAESsectury(aes); //server
		...
		//看到这行了木有，这里第2个参数就是AES的默认密码
		uartReciveThread = new UartReciveThread(mHandler , "123456");
		uartReciveThread.start();
